...
// После замены восстанавливаем область выделения, т.к. объем текста мог стать больше
app.findGrepPreferences = null; 
app.changeGrepPreferences = null;
...
app.findGrepPreferences = null; 
app.changeGrepPreferences = null;
var pBText = "Оформление номеров страниц в указателе";
...
pBar = new ProgressBar("Особое оформление номеров страниц");
...
pBar.reset("4/4 Удаление вспомогательных тегов", 3);
app.findGrepPreferences = null; 
app.changeGrepPreferences = null;
