...
1. Создаем новый файл (без разворота), помещаем в него файл с необработанными тегами, сохраняем.
2. Открыты два файла. Идем по тегам скриптом `#ApplyCharacterStyle.2024.jsx`, для каждого ставим курсор и ищем нужный случай в верстке, затем применяем стиль и переходим к следующему.
