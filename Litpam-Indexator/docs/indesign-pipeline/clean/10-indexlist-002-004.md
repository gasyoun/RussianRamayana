...
2. Вставляем в верстку. Пустых строк много: выделяем нижнюю пустую, прокручиваем вверх, с `Shift` выделяем весь блок пустых строк — удаляем. Убираем и верхнюю служебную строку.
