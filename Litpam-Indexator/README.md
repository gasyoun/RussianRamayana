...
## Текущее состояние (12-08-2026)

Аудит PDF 12.10.25 подтвердил: оба тома уже содержат четыре оформленных указателя.
Они являются визуально-редакционной базой, но не доказательством актуальности ссылок
после обновления книг. Программа миграции в InDesign 2026, повторной генерации и
подготовки evidence packets описана в
